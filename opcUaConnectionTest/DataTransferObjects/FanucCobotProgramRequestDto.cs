...
namespace PG.LIFT.Integrations.EMMS.DataTransferObjects
{
    ...
    public static class FanucCobotProgramRequestDtoExtensions
    {
        ...
        public static byte[] ToByteArrayExecFalse(this FanucCobotProgramRequestDto dto)
        {
            ...
            string integrationVehicleId)
        {
            ...
            return new FanucCobotProgramRequestDto
            {
                IntegrationVehicleId = integrationVehicleId,
                Station = BitConverter.ToInt32(bytes, IntsOffset),                    // ints[0]
                Task = BitConverter.ToInt32(bytes, IntsOffset + sizeof(int)),           // ints[1]
                TransferPoint = BitConverter.ToInt32(bytes, IntsOffset + sizeof(int) + sizeof(int)),  // ints[2]
